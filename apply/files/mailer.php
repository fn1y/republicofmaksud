...
$form_fields = array(
"element0" => 'Minecraft IGN',
"element1" => 'Discord Tag',
"element2" => 'Your Email',
"element3" => 'I agree to follow the server rules, and make things fun for everyone else!'
);

$required_fields = array("element0", "element1", "element2", "element3");

$mail_from_name 	= "element0";
$mail_from_email 	= "element2";
$mail_subject 		= "element1";
...
$message_success = 'You just applied! poggers';
